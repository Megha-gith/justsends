        ...
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <form class="form-signin" method = "POST" action = "read.php" enctype="multipart/form-data">
              ...
              <button class="btn btn-lg btn-success btn-block text-uppercase" type="submit" name = "submit" value ="submit" style="background-color: #3e8e41;
  box-shadow: 0 5px #666;
  transform: translateY(4px);";>READ MESSAGE</button>
